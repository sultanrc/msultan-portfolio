...
import porto from '@/assets/images/porto.jpeg'
import ews from '@/assets/images/ews.jpeg'
...
<template>
        ...
        <div class="flex flex-col ms-2">
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 512 512"
              class="w-4 h-4 ml-2 text-slate-600 fill-current group-hover:-translate-y-1 group-hover:text-white transition"
            >
              <path
          ...
          <p class="tracking-wide leading-[1.4] mt-2 text-xs group-hover:text-white">
            ...
            database and displayed on a web dashboard for easy monitoring. I contributed by
            designing the UI using Tailwind CSS, developing the frontend with Vue.js, and building
            the backend API with Express.js. The system triggers alerts if the temperature exceeds
            30°C or humidity surpasses 80%, helping IT staff prevent overheating.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="flex flex-col ms-2">
          ...
          <p class="tracking-wide leading-[1.4] mt-2 text-xs group-hover:text-white">
            ...
            developer needs a fancy place to flex their skills. The site has an About, Experience,
            and a Projects section showcasing my work. And since I was running low on projects, I
            shamelessly added this very portfolio site to the Projects section—because why not? 😁
            It’s a fun little project where I experimented with clean UI, smooth animations, and
            just enough personality to make recruiters smile (hopefully).
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="p-4 rounded-lg transition">more to come..</div>
</template>
